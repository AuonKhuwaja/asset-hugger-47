      ...
      <form onSubmit={handleSubmit} className="vision-card p-6 space-y-6 animate-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="space-y-1.5">
            ...
            <Input id="name" placeholder="e.g. MacBook Pro 16 inch" value={form.name} onChange={(e) => update("name", e.target.value)} className="bg-[rgba(6,11,40,0.6)] border-border/30 rounded-xl" />
          ...
          <div className="space-y-1.5">
            ...
            <Input id="model" placeholder="e.g. A2485" value={form.model} onChange={(e) => update("model", e.target.value)} className="bg-[rgba(6,11,40,0.6)] border-border/30 rounded-xl" />
          ...
          <div className="space-y-1.5">
            ...
            <Input id="serial" placeholder="e.g. C02FW3LYMD6T" value={form.serialNumber} onChange={(e) => update("serialNumber", e.target.value)} className="bg-[rgba(6,11,40,0.6)] border-border/30 rounded-xl" />
          ...
          <div className="space-y-1.5">
            ...
            <Input id="date" type="date" value={form.purchaseDate} onChange={(e) => update("purchaseDate", e.target.value)} className="bg-[rgba(6,11,40,0.6)] border-border/30 rounded-xl" />
          ...
          <div className="space-y-1.5">
            ...
            <Input id="cost" type="number" placeholder="e.g. 250000" value={form.purchaseCost} onChange={(e) => update("purchaseCost", e.target.value)} className="bg-[rgba(6,11,40,0.6)] border-border/30 rounded-xl" />
          ...
          <div className="space-y-1.5">
            ...
            <Input id="vendor" placeholder="e.g. Apple Inc." value={form.vendor} onChange={(e) => update("vendor", e.target.value)} className="bg-[rgba(6,11,40,0.6)] border-border/30 rounded-xl" />
        ...
        <div className="space-y-1.5">
          ...
          <Textarea id="desc" placeholder="Additional notes..." value={form.description} onChange={(e) => update("description", e.target.value)} className="bg-[rgba(6,11,40,0.6)] border-border/30 rounded-xl min-h-[100px]" />
        </div>
