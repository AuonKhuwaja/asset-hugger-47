          ...
          <div className="flex items-center gap-3">
            <ExportButtons
              ...
              columns={[
                ...
                { header: "Email", accessor: (v: Vendor) => v.email },
            ...
            <tbody>
              {pag.paged.map(v => (
                <tr key={v.id} className="border-b border-dashed border-border transition-colors hover:bg-muted/50">
                  ...
                  <td className="px-4 py-3 text-muted-foreground border-r border-dashed border-border last:border-r-0">{v.contactPerson}</td>
                  <td className="px-4 py-3 text-muted-foreground border-r border-dashed border-border last:border-r-0">{v.email}</td>
                  <td className="px-4 py-3 text-muted-foreground border-r border-dashed border-border last:border-r-0">{v.phone}</td>
                  <td className="px-4 py-3 text-muted-foreground border-r border-dashed border-border last:border-r-0">{v.category}</td>
