              ...
              <thead>
                <tr className="border-b-2 border-dashed border-border bg-primary text-primary-foreground">
                  {["ID", "Asset", "Type", "Description", "Technician", "Date", "Recurrence", "Cost", "Status", "Actions"].map((h) => (
                    <th key={h} className={`px-4 py-3 text-xs font-bold uppercase tracking-wider text-primary-foreground ${h === "Cost" ? "text-right" : "text-left"} border-r border-dashed border-primary-foreground/60 last:border-r-0`}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                {pag.paged.map((m) => (
                  <tr key={m.id} className="border-b border-dashed border-border transition-colors hover:bg-muted/50">
                    ...
                    <td className="px-4 py-3 text-muted-foreground max-w-[200px] truncate border-r border-dashed border-border last:border-r-0">{m.description}</td>
                    <td className="px-4 py-3 text-muted-foreground border-r border-dashed border-border last:border-r-0">{m.technician}</td>
                    <td className="px-4 py-3 tabular-data text-muted-foreground border-r border-dashed border-border last:border-r-0">{m.date}</td>
                    <td className="px-4 py-3 border-r border-dashed border-border last:border-r-0">
                    ...
                    <td className="px-4 py-3 text-right tabular-data font-medium text-primary border-r border-dashed border-border last:border-r-0">PKR {m.cost.toLocaleString()}</td>
                    <td className="px-4 py-3 border-r border-dashed border-border last:border-r-0"><StatusBadge status={m.status} /></td>
                    <td className="px-4 py-3 border-r border-dashed border-border last:border-r-0">
