        ...
        <form onSubmit={handleSubmit} className="vision-card p-6 space-y-4 animate-fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input type="number" placeholder="0" className="bg-[rgba(6,11,40,0.6)] border-border/30 rounded-xl" />
            </div>
            <div className="space-y-1.5">
              <Label className="text-muted-foreground text-xs font-semibold uppercase tracking-wider">Technician</Label>
              <Input placeholder="Name" className="bg-[rgba(6,11,40,0.6)] border-border/30 rounded-xl" />
            </div>
          </div>
          <div className="space-y-1.5">
            <Label className="text-muted-foreground text-xs font-semibold uppercase tracking-wider">Description</Label>
            <Textarea placeholder="Describe the work..." className="bg-[rgba(6,11,40,0.6)] border-border/30 rounded-xl min-h-[80px]" />
          </div>
